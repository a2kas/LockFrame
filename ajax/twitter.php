...
define('CONSUMER_KEY', 'RPKwklRAI3jlCDVv07ui0YpE9');
define('CONSUMER_SECRET', 'zPre4bBbeMpkFb54yLrA9uyfyAIPTF7guUincLHSvLzDCmam2C');
/**
...
$list = json_decode(search_for_a_term($bearer_token, "lockframe", 'default'));
$date = $list->statuses[0]->created_at;
