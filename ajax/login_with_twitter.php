 ...
 */
	 ...
	 */
	//define('OAUTH_PIN', 6023203);
	if(defined('OAUTH_PIN'))
		$client->pin = OAUTH_PIN;


	$client->client_id = 'HzZ44pjmqvMXUjV5k86xBBuaZ'; $application_line = __LINE__;
	$client->client_secret = 'F2MU0MjRMFEcC3Stxq4Byvyg90L3Hg8XeVTOt1bU11gM8tKVkB';
